...
import com.rabbiter.hospital.component.EmailClient;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Boolean addOrder(Orders order, String arId){
        ...
        // 挂号成功后，需要发送邮件打开以下代码
        //emailClient.sendEmail(order.getPatient().getPEmail(), emailClient.getTitle(), "您已成功预约医生"+ order.getPatient().getPName()+"时间"+order.getOStart()+ "的挂号");
        return true;
    }
    /**
     * 根据pId查询挂号
